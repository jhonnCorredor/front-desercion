...
export default function QuestionnaireForm() {
        ...
        try {
            ...
            const questionnaire = {
                ...
                preguntas: response.map(p => ({
                    ...
                    opciones: p.pregunta_tipo === "seleccion multiple" 
                        ? JSON.parse(p.pregunta_opciones || "[]")
                        : [],
            ...
            setQuestionnaire({id: null, nombre: "", descripcion: "", preguntas: []});
        }
    }, []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Aquí iría la llamada a la API para enviar las respuestas
            // await Service.post("/cuestionario/respuestas/", data);
        ...
        <div className="min-h-screen bg-gray-50 rounded-xl mt-6">
            <div className="mx-auto container p-4">
                <div className="mb-6 flex items-center gap-3">
                    <img src="/img/logoSena.jpg" alt="Logo SENA" className="h-12 w-12 rounded-full" />
